...
then
    PYTHONPATH="$ROOT" python -m src.simswap.main third_party=simswap third_party.function=$function log.file_suffix=$suffix log.record_level=$log_level third_party.defense.epochs=335
