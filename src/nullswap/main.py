...
from src.nullswap.defense import Defense
...
def main(config: DictConfig):
    ...
    timer = common_utils.Timer(f"NullSwap {config.third_party.function}", logger)

    defense = Defense(logger, config)
    defense_function_list = ["train", "sample", "metric"]
