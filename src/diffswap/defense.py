...
from src.common_utils import save_tensor_imgs, check_tensor_info
...
class Defense(Base):
    ...
    def swap(self) -> None:
        ...
        for idx, (imgs_A, imgs_B) in enumerate(dataloader, start=1):
            ...
            source_swap = self.swap_face_original_pipeline(imgs_A, imgs_B)
            target_swap = self.swap_face_original_pipeline(imgs_B, imgs_A)
