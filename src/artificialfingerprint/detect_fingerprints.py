...
#         os.path.dirname(__file__), "encode_samples", "fingerprinted_images"
#     ),
...
parser.add_argument(
    "--data_dir",
    type=str,
    default=os.path.join(os.path.dirname(__file__), "robustness", exp),
    help="Directory with images.",
)
parser.add_argument(
    "--output_dir",
    type=str,
    default=os.path.join(os.path.dirname(__file__), "decode_results", exp),
...
parser.add_argument(
    "--decoder_path",
    type=str,
    default=os.path.join(os.path.dirname(__file__), "checkpoint", "decoder.pth"),
...
if __name__ == "__main__":
    ...
    generate_random_fingerprints(100, 1)
    load_decoder()
    load_data()
